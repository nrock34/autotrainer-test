...
class MDXNetDereverb:
    def __init__(self, chunks):
        self.onnx = "/notebooks/autotrainer/rvc/uvr5_weights/onnx_dereverb_By_FoxJoy"
        ...
        os.makedirs("./dereverb_vocal_root", exist_ok=True)
        os.makedirs("./dereverb_ins_root", exist_ok=True)


    def _path_audio_(self, input, vocal_root="./dereverb_vocal_root", others_root="./dereverb_ins_root", format='wav'):
